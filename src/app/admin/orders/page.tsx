...
//   const [productNames, setProductNames] = useState<{ [key: string]: { name: string; image: string } }>({}); // Updated type
...
//           image: product && product.image ? product.image : "", // Make sure the product has an image property
//         };
//       });
