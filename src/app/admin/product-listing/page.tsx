                                ...
                                <table className="min-w-full rounded-lg">
                                    <thead className="bg-lightGray">
                                        <tr className="py-3">
                                            ...
                                            <th className="px-6 py-3 text-left text-xs font-semibold text-gray-500">Product Name</th>
                                            <th className="px-6 py-3 text-center text-xs font-semibold text-gray-500">Price</th>
                                            <th className="px-6 py-3 text-center text-xs font-semibold text-gray-500">Stock</th>
                                            <th className="px-6 py-3 text-center text-xs font-semibold text-gray-500">Recommended</th>
                                            <th className="px-6 py-3 text-center text-xs font-semibold text-gray-500">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody className="bg-white dark:bg-gray-900">
                                        {ProductStore.products.map((product, index) => (
                                            <tr key={index} className="hover:bg-gray-100 dark:hover:bg-gray-700 border-b border-b-lightGray">
                                                ...
                                                <td className="px-4 py-2 text-center whitespace-nowrap text-sx font-medium text-gray-900 dark:text-gray-100 w-[80px]">
                                                    <Switch
                                                        ...
                                                        onChange={() => handleToggleRecommended(product._id)}
                                                    />
                                                </td>
                                                <td className="px-4 py-2 text-center whitespace-nowrap text-sx font-medium text-gray-900 dark:text-gray-100 w-[80px]">
                                                    <button
