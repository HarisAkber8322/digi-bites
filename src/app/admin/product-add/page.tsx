        ...
        {({ isSubmitting }) => (
          <Form className="space-y-4">
            ...
            <div className="flex flex-col">
              ...
              />
              <ErrorMessage name="name" component="div" className="text-themeYellow" />
            </div>
            ...
            <div className="flex flex-col">
              ...
              <Field
                ...
                className="mt-1 block w-full px-3 py-2 border border-lightGray rounded-md shadow-sm focus:outline-none focus:themeOrange focus:border-themeOrange sm:text-sm"
              />
              <ErrorMessage name="price" component="div" className="text-themeYellow" />
            </div>
            ...
            <div className="flex flex-col">
              ...
              <Field
                ...
                className="mt-1 block w-full px-3 py-2 border border-lightGray rounded-md shadow-sm focus:outline-none focus:themeOrange focus:border-themeOrange sm:text-sm"
              />
              <ErrorMessage name="description" component="div" className="text-themeYellow" />
            </div>
            ...
            <div className="flex flex-col">
              ...
              <ErrorMessage name="category" component="div" className="text-themeYellow" />
            </div>
            ...
            <div className="flex flex-col">
              ...
              <Field
                ...
                className="mt-1 block w-full px-3 py-2 border border-lightGray rounded-md shadow-sm focus:outline-none focus:themeOrange focus:border-themeOrange sm:text-sm"
              />
              <ErrorMessage name="image" component="div" className="text-themeYellow" />
            </div>
            ...
            <div className="flex flex-col">
              ...
              <Field
                ...
                className="mt-1 block w-full px-3 py-2 border border-lightGray rounded-md shadow-sm focus:outline-none focus:themeOrange focus:border-themeOrange sm:text-sm"
              />
              <ErrorMessage name="stock" component="div" className="text-themeYellow" />
            </div>
            ...
            <div className="flex flex-col">
              ...
              <Field
                ...
                className="mt-1 block w-full px-3 py-2 border border-lightGray rounded-md shadow-sm focus:outline-none focus:themeOrange focus:border-themeOrange sm:text-sm"
              />
              <ErrorMessage name="addons" component="div" className="text-themeYellow" />
            </div>
