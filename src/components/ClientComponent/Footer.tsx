...
const Footer: React.FC = () => {
  ...
  return (
    <Div
      themeDivClasses="border-t-4 border-themeYellow"
      content={
        <>
          <div className="md:w-[1180px] m-auto flex justify-between items-center py-2">
            ...
            <div
              className={`relative flex items-center ml-32 transition-all duration-400 ease-in-out text-themeYellow ${isHovered ? "w-60" : "w-10"
                } overflow-hidden`}
